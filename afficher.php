...
<a class="navbar-brand" href="../index.php">JojoShop</a>
    ...
    <a class="btn btn-danger d-flex" style="display: flex; justify-content: flex-end;" href="destroy.php">deconnection</a>
    </div>
</div>
</nav>
