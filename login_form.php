		...
		<div class="row">
			<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 text-center infinity-form">
				...
				<form class="px-3" action="" method="POST">
					...
					<div class="mb-3">
						<button type="submit" name="submit" class="btn btn-block">connexion</button>
					</div>
					<div class="text-center mb-5" style="color: #777;">pas de compte?
						<a class="login-link" href="register_form.php">Inscription</a>
					</div>
				</form>
			</div>
		</div>
